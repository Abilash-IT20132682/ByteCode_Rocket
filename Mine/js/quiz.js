...
const quizdata=[
      ...
      },
      {
        ...
        options:["1 year", "6 months", "3 months", "3 years"],
        answer:"3 months",
        category:2
      },
      {
        question:"Who discovered the Crab Nebula?",
        options:["Charles Messier", "Ernst Otto Fischer", "John Flamsteed", "John Bevis"],
        answer:"John Bevis",
        category:3
      },
      {
        question:"Which planets do not have a natural satellite?",
        options:["Mercury and Neptune", "Uranus and Venus", "Mercury and Venus", "Mercury and Saturn"],
